...
PARAM  <- list()
PARAM$experimento <- "FE7310-last-05"

PARAM$exp_input  <- "DR7210-last-01"
...
PARAM$CanaritosAsesinos$ratio  <- 3       #varia de 0.0 a 2.0, si es 0.0 NO se activan
PARAM$CanaritosAsesinos$desvios  <- 2.5      #desvios estandar de la media, para el cutoff
PARAM$CanaritosAsesinos$semilla  <- 800161   # cambiar por la propia semilla
