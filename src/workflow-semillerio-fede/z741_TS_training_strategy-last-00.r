...
PARAM  <- list()
PARAM$experimento <- "TS7410-last-00"

PARAM$exp_input  <- "FE7310-last-00"

# me salteo los meses duros de pandemia, pero llego hasta 201907 en training
# entreno en 18 meses

PARAM$future       <- c( 202109 )
PARAM$final_train  <- c( 202107, 202106, 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202002, 202001 )
...
PARAM$train$semilla  <- 800161  # cambiar por su propia semilla  !!!
