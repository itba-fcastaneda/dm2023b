...
PARAM  <- list()
PARAM$experimento  <- "ZZ7950-last-06"
PARAM$exp_input  <- "HT7510-last-06"
...
PARAM$semilla_primos  <- 800161  # se utiliza para generar el vector de  PARAM$semillerio  semillas
